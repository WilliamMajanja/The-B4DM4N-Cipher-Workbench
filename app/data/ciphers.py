...
class CipherDict(TypedDict):
    ...
    suggestedKeyword: NotRequired[str]
    notes: NotRequired[str]
    pdf_path: NotRequired[str]


custom_cipher_template: CipherDict = {
    'id': 'custom',
    'name': 'Custom Cipher',
    'type': 'CUSTOM',
...
ciphers: list[CipherDict] = [
    ...
    },
    {
        ...
        'pdf_path': 'static/pdfs/torah_genesis.pdf',
    },
    {
        'id': 'quran_al-fatiha',
        ...
        'pdf_path': 'static/pdfs/quran_al_fatiha.pdf',
    },
    {
        'id': 'bhagavad_gita',
        ...
        'pdf_path': 'static/pdfs/bhagavad_gita.pdf',
    },
    {
        'id': 'dhammapada',
        ...
        'pdf_path': 'static/pdfs/dhammapada.pdf',
    },
    {
        'id': 'tao_te_ching',
        ...
        'pdf_path': 'static/pdfs/tao_te_ching.pdf',
    },
    {
        'id': 'emerald_tablet',
        ...
        'pdf_path': 'static/pdfs/emerald_tablet.pdf',
    },
    {
        'id': 'meditations',
        ...
        'pdf_path': 'static/pdfs/meditations.txt',
    },
    {
        'id': 'cicada_3301',
